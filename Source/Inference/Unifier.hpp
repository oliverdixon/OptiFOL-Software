...
/**
 * @class Unifier
 * @brief A thin wrapper for Variable-to-term substitutions; typically generated by BidirectionalUnificationVisitor and
 *  consumed by UnificationApplicationVisitor.
 */
struct Unifier : ISerialisable
{
     ...
     *  guarantees conferred by a non-ephemeral SymbolRepository.
     */
