 ...
 *
 * @details
 *  The <i>Failed Tests View</i> presents a read-only tabular representation of PartialTestResult objects, grouped by
 *  their respective owning Test objects, which are in turn grouped by the TestGroup objects. The following GTK elements
 ...
 *          <td>Table detained by <code>test_groups_failed_container</code> tabulating PartialTestResult fields.</td>
 *      </tr>
 *      <tr>
 *          <td>Gtk::ColumnViewColumn</td>
 *          <td><code>failed_test_message</code></td>
 *          <td>Table column to display the message of the PartialTestResult, or the name of the Test thereof.</td>
 *      </tr>
 *      <tr>
 *          <td>Gtk::ColumnViewColumn</td>
...
private:
    ...
    /**
     * @brief Handles a change in the model. In particular, show or hide the entire @ref container viewing pane.
