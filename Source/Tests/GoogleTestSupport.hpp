 ...
 *      <li>Inverse equality comparison with <code>Candidate::operator!=(const Candidate&)</code>, noting that
 * this can often be generated by compilers given a valid equality operator overload;</li> <li>Stream-bound
 * serialisation with <code>operator<<(std::ostream&, const Candidate&)</code>.</li>
 *  </ul>
