...
bool VariableNode::accept(UnificationVisitor &visitor, const ITermNode &target) const
{
    return visitor.visit(*this, target);
}

bool VariableNode::accept(UnificationVisitor &visitor, const VariableNode &target) const
{
    return visitor.visit(*this, target);
}
