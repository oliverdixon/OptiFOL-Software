 ...
 * @brief Bidirectional variant of the UnificationVisitor, permitting substitutions in the generalisation and the
 *  instance, and includes an occurs-check for sanity-checking substitutions.
 */
...
protected:
     ...
     */
    [[nodiscard]] bool variable_generic(const Variable &variable_lhs, const IProcessedTerm &generic_term_rhs) override;
