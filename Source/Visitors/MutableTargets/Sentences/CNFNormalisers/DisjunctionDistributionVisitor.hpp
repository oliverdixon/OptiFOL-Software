 ...
 * of nested conjunctions. In particular, <ul> <li><code>P | (Q & R)</code> becomes <code>(P | Q) & (P |
 * R)</code>; and likewise, </li> <li><code>(P & Q) | R</code> becomes <code>(R | P) & (R | Q)</code>.</li>
 * </ul>
...
private:
     ...
     * nodes, respectively.
     */
    std::stack<std::pair<std::unique_ptr<IMutableSentence>, std::unique_ptr<IMutableSentence>>>
            tracked_operands;
