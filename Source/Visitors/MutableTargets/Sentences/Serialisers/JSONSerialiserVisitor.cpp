...
void JSONSerialiserVisitor::visit(const MutableQuantified &node)
{
...
void JSONSerialiserVisitor::visit(const MutableBinaryConnected &node)
{
...
void JSONSerialiserVisitor::visit(const MutableIdentity &node)
{
    output = {
        { "type", "equality" },
